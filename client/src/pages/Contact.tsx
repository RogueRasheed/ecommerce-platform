    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white text-gray-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16 text-center">
          {[
            { icon: <Mail className="w-6 h-6 text-[#009632] mx-auto mb-3" />, title: "Email", value: (<><span>aminerunigent@yahoo.com</span> <br /> <span>info@aminerufoods.com</span></>) },
            ...
            { icon: <MapPin className="w-6 h-6 text-[#009632] mx-auto mb-3" />, title: "Address", value: (<><span>226, Murtala Mohammed Way, Imaro House, Benin City, Edo State, Nigeria</span></>) },
          ].map((item, i) => (
            <div
              key={i}
